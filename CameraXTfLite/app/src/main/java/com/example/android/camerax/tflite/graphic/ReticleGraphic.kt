 ...
 */
internal class ReticleGraphic(
    overlay: GraphicOverlay,
    boxRect: RectF,
    private val animator: CameraReticleAnimator,
) : GraphicBase(overlay, boxRect) {
    ...
    init {
        ...
        rippleSizeOffset =
            resources.getDimensionPixelOffset(R.dimen.reticle_ripple_size_offset)
        rippleStrokeWidth =
            resources.getDimensionPixelOffset(R.dimen.reticle_ripple_stroke_width)
