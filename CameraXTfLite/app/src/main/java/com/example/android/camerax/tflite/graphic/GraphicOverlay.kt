...
import com.example.android.camerax.tflite.graphic.GraphicOverlay.Graphic
import java.util.*
 ...
 *
 * Associated [Graphic] items should use [translateX] and [translateY]
 * to convert to view coordinate from the preview's coordinate.
 */
